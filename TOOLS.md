...
Complete documentation for all 228 tools in `salesforce-metadata-mcp`. (Highlights below cover the most commonly used tools in depth; see the README's full 228-tool table for every tool name.)
...
*For the complete list of all 228 tools, see [README.md](README.md).*
