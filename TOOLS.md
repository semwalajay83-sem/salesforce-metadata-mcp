...
Complete documentation for all 221 tools in `salesforce-metadata-mcp`. (Highlights below cover the most commonly used tools in depth; see the README's full 221-tool table for every tool name.)
...
*For the complete list of all 221 tools, see [README.md](README.md).*
